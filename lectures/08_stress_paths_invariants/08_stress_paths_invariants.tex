...
~\Cref{eq:strain-stress} and \cref{eq:pq-strain} in~\cref{eq:strain-strain} to relate $\varepsilon_v, \varepsilon_s$ to $p, q$:
\begin{equation*}
	\begin{bmatrix}
		\varepsilon_v \\
		\varepsilon_s \\
...
%----------------------------------------------------------------------------------------
\begin{frame}{Triaxial test}
 	\begin{figure}
		\includegraphics[width=0.45\textwidth]{figs/triaxial.png}
	\end{figure}
\end{frame}
...
\begin{figure}
    \includegraphics[width=\textwidth]{figs/pi-plane.png}
\end{figure}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.49\linewidth}
\begin{figure}
    \includegraphics[width=\textwidth]{figs/octahedral-stress-profile.png}
\end{figure}
\end{minipage}
\end{frame}
...
\begin{itemize}
	...
	\item Deviatoric strain: $ \varepsilon_s = \sqrt{\frac{2}{3}}\sqrt{(\varepsilon_{I}^\prime - \varepsilon_{II}^\prime)^2 + (\varepsilon_{II}^\prime - \varepsilon_{III}^\prime)^2 + (\varepsilon_{III}^\prime - \varepsilon_{I}^\prime)^2} $
...
\note{
	Volumetric strain $\varepsilon_v = \varepsilon_{11} + \varepsilon_{22} + \varepsilon_{33}$
	
	Deviatoric strain: $\varepsilon_s = \sqrt{2/3}\sqrt{e_{11}^2 + e_{22}^2 + e_{33}^2+ \gamma_{12}^2/2+ \gamma_{23}^2/2 + \gamma_{31}^2/2}$
	Where
	$e_{11} = \varepsilon_{11} - \varepsilon_v / 3, e_{22} = \varepsilon_{22} - \varepsilon_v / 3, e_{33} = \varepsilon_{33} - \varepsilon_v / 3$
}
...
\note{Smallest angle between the line of pure shear and the projection of the stress tensor on the deviatoric plane}
