...
\begin{frame}
	\frametitle{Stress - dilatancy theory (Taylor, 1948)}
	\begin{figure}
		\includegraphics[width=\textwidth]{figs/taylor-drained-shear.png}
	\end{figure}
\end{frame}
...
%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Interlocking (Taylor, 1948)}
	\begin{figure}
		\includegraphics[width=0.9\textwidth]{figs/interlocking.png}
	\end{figure}
\end{frame}

\note{
	Terzaghi's review of Taylor's book
	``I am convınced that the theorıes of soıl mechanıcs and the results of laboratory tests serve only to guıde the engıneer toward a recognıtıon of the factors whıch may affect the desıgn and constructıon of a real project"		
	from review sent to Wiley by R B Peck July 31 1944 quoted from page 213 “Karl Terzaghi; the Engineer as Artist” R E Goodman (1999)}

\note{
John Wiley \& Sons reply to Terzaghi

... (Taylor’s book) will be published by one of our competitors if we do not take it. Under the circumstances, we see nothing to do but publish it.

However, as I said in the first paragraph of this letter, we believe that each book will be judged on its own merits, and certainly we have no fears for the success of (Terzaghi \& Peck).

- E P Hamilton (President)        December 17, 1946
}
%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Belidor's friction hypothesis, 1737}
	\begin{figure}
		\includegraphics[width=\textwidth]{figs/friction-belidor.png}
	\end{figure}
\end{frame}

\note{
Belidor attributed sliding friction coefficients of 1/3 to the hemispherical geometry of roughness
Navier (1819) called Belidor’s theory très-fautive (very faulty) but he offered no alternative to it.
}
%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Coulomb, 1776}
	\begin{figure}
		\includegraphics[width=\textwidth]{figs/grand-canyon.jpeg}
	\end{figure}
\end{frame}

\note{
  
Coulomb, at school in Mezieres, learned friction theory from a text book written by Belidor in 1737 (reprinted with notes by Navier in 1819) and a Dutch concept of (cohesion) = (adhesion). In his 1773 paper he reported new rock strength data
Terzaghi (1936), in “A fundamental fallacy in earth pressure computation”, rejected Rankine’s theory of limiting statics of granular media, (Sokolovski), for lacking consideration of strains
}
...
\begin{frame}
	\frametitle{Coulomb, 1776}
	\begin{figure}
		\includegraphics[width=0.45\textwidth]{figs/coulomb-friction.png}
	\end{figure}
\end{frame}

\note{Coulomb defined soil internal friction as the angle of repose $\phi_d$ of drained slopes.
  In Coulomb’s rock tests, cohesion in shear was slightly greater than adhesion in tension,
  so he considered it safe to design with tension data His wall design assumed that newly compacted
  soil has zero cohesion }


%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Terzaghi interprets Hvorslev’s (1937) shear box tests}
	\begin{figure}
		\includegraphics[width=0.8\textwidth]{figs/cs-wet-terzaghi-error.png}
	\end{figure}
\end{frame}

\note{Terzaghi fitted “true” cohesion and friction to peak strengths found by Hvorslev  in shear box tests, normalısıng them by equıvalent pressure.

 \textbf{A point Terzaghi missed in interpreting test data}: Hvorslev’s data ended at a critical state point. 
Terzaghi should have asked Hvorslev why he put equations in space where there were no peak strengths. Filling the space meant that he asked no questions about the wet side of critical states $v_\lambda= { v+\lambda \ln p^\prime} > \Gamma$.
}

%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Terzaghi misinterprets Hvorslev’s (1937) shear box tests}
	\begin{figure}
		\includegraphics[width=0.8\textwidth]{figs/incorrect-cohesion.png}
	\end{figure}
\end{frame}

%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Plastic design of a steel frame, Baker (1948)}
	\begin{figure}
		\includegraphics[width=0.65\textwidth]{figs/baker-plastic-steel-frame.png}
	\end{figure}
\end{frame}
\note{Cambridge text book  example plastic design of shelter to resist floor load 20 lb/sq.ft falling 9 ft in bombed house; Mother and 3 children survived WW II 250kg bomb in Falmouth, UK.

  A paste of soil saturated with water is plastic, (from the Greek word $\pi\lambda\alpha\sigma\sigma\epsilon l \nu$ \textit{plassein} to mould, as in moulding pottery from clay).
  
An aggregate of separate hard grains ın a crıtıcal state behaves as a ductile plastic continuum.
Plastic design guıdes us to select construction materials and methods; soil is not plastic and ductile if over compacted to high peak strength 
}

%----------------------------------------------------------------------------------------
\begin{frame}
	\frametitle{Calladine's associated plastic flow (1963)}
	\begin{figure}
		\includegraphics[width=0.75\textwidth]{figs/caladine-plastic-flow.png}
	\end{figure}
\end{frame}

\note{
Yield loci for paste with $v_\kappa$ = (const) on wet side of Critical-states, satisfy the associated flow rule $dp^\prime dv +dqd\varepsilon=0$. The Original Cam-clay locus was based on this plus Thurairajah’s dissipation function.}
