...
%------------------------------------------------
\begin{frame}
\frametitle{Numerical analysis of geotechnical problems}
\mode<beamer>{
\begin{itemize}
	\item Conceptualize the system
	\begin{itemize}
...
Based on principle of discretisation to solve complex boundary problems
\mode<beamer>{
	\begin{itemize}
		\item Steady state (time-independent)
		\begin{itemize}
			\item Steady seepage state
