...
\note{Tensile forces produce a total elongation 	
	(deformation) $\delta$ of the spring. For linear springs, the force $T$ and the displacement $u$ are related by Hooke’s law. where deformation of the spring $\delta$ is given as: $\delta = u(L) - u(0) = u_2 - u_1$. Forces $f_{1x} = -T$ and $f_{2x} = T$.
	\begin{figure}
